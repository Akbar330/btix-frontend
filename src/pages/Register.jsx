...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[500px] bg-indigo-300/40 rounded-full mix-blend-multiply filter blur-[100px] animate-blob pointer-events-none"></div>
            <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[500px] bg-sky-400/30 rounded-full mix-blend-multiply filter blur-[120px] animate-blob animation-delay-2000 pointer-events-none"></div>

            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
                <Link to="/" className="flex justify-center mb-6 group">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-400 to-indigo-500 flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-indigo-500/30 border border-white/20 transform group-hover:scale-105 group-hover:-rotate-6 transition-all">
                        B
                    </div>
                </Link>
                ...
                <p className="mt-2 text-center text-sm font-medium text-slate-500">
                    Join BANGSA TIX.ID and discover amazing events
                </p>
            </div>
                ...
                >
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm font-medium text-slate-500">
                            ...
                            <Link to="/login" className="font-bold text-primary-600 hover:text-primary-700 hover:underline transition-colors pb-1 border-b-2 border-transparent hover:border-primary-400">
                                Log in instead
                            </Link>
                        </p>
                    </div>
