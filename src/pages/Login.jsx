    ...
    return (
        <div className="page-shell min-h-screen">
            <div className="tix-container flex min-h-screen items-center justify-center py-10">
                <div className="grid w-full max-w-6xl gap-8 lg:grid-cols-[1fr_0.88fr]">
                    <MotionDiv
                        initial={{ opacity: 0, x: -24 }}
                        animate={{ opacity: 1, x: 0 }}
                        className="hidden rounded-2xl bg-[linear-gradient(135deg,#0d2b57_0%,#143d79_50%,#d8a646_160%)] p-10 text-white shadow-[0_30px_80px_rgba(16,39,74,0.22)] lg:flex lg:flex-col lg:justify-between"
                    >
                        <div className="tix-brand text-[3.6rem] leading-none text-white">
                            BANGSA TIX<span className="tix-brand-mark" />ID
                        </div>
                        <div>
                            <p className="text-xs font-extrabold uppercase tracking-[0.28em] text-[#ffe7aa]">User Access</p>
                            ...
                            <p className="mt-5 max-w-lg text-sm leading-7 text-white/82">
                                Masuk ke akun Anda untuk melihat tiket, melanjutkan pembayaran, dan memantau pesanan dalam tampilan yang seragam dengan halaman utama.
                            </p>
                        </div>
                    </MotionDiv>
                    ...
                    >
                        ...
                        <div className="mt-8 text-center text-sm text-[var(--text-muted)]">
                            Belum punya akun?{' '}
                            <Link to="/register" className="font-extrabold text-[var(--brand-navy)]">
                                Daftar sekarang
                            </Link>
                        </div>
                    </MotionDiv>
